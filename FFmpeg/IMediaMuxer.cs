...
public interface IMediaMuxer
{
    ...
    /// <summary>
    /// Copies container tags, chapters, cover art (<c>attached_pic</c>), and matching stream
    /// tags/dispositions from source onto destination (rewrites destination in place).
    ...
    /// </summary>
    /// <param name="source">File providing metadata (and chapters / cover art).</param>
